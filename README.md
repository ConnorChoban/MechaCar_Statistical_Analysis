...
- From our analysis we can see that the r-squared value is 0.7149 which indicates that there is approximately 71.49% chance that future data points will fit this model. As such, while this model does effectively predict mpg of prototypes, there is room for improvement. 
